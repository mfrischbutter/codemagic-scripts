...
IOS_ARTIFACT_URL=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$IOS_ARTIFACT_TYPE"'")) | .url')
IOS_ARTIFACT_NAME=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$IOS_ARTIFACT_TYPE"'")) | .name')
IOS_TYPE=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$IOS_ARTIFACT_TYPE"'")) | .type')
IOS_BUNDLE=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$IOS_ARTIFACT_TYPE"'")) | .bundleId')

ANDROID_ARTIFACT_URL=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$ANDROID_ARTIFACT_TYPE"'")) | .url')
ANDROID_ARTIFACT_NAME=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$ANDROID_ARTIFACT_TYPE"'")) | .name')
ANDROID_TYPE=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$ANDROID_ARTIFACT_TYPE"'")) | .type')
ANDROID_BUNDLE=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$ANDROID_ARTIFACT_TYPE"'")) | .bundleId')


VERSION_NAME=$(echo $CM_ARTIFACT_LINKS | jq -r '.[] | select(.name | endswith("'"$IOS_ARTIFACT_TYPE"'")) | .versionName')
...
sed -i.bak "s/\$ANDROID_ARTIFACT_URL/$ANDROID_ARTIFACT_URL/" .templates/jira.json
sed -i.bak "s/\$IOS_ARTIFACT_URL/$IOS_ARTIFACT_URL/" .templates/jira.json
